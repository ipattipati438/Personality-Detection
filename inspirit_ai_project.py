...
X_train, X_test, y_train, y_test = train_test_split(
    X_imputed, y_encoded, test_size=0.33, random_state=42
)
...
treeM = DecisionTreeClassifier(random_state=0, max_depth = 10)
...
'''
print(random_tree_weight)
print(mlp_model_weight)
print(classifier_tree_weight)
print(neighbors_model_weight)
'''
...
#print(weighted_combined_classifier_prediction_test)
...
# Method of combining when you don't know the accuracy of the model
